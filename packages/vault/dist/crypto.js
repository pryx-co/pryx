...
import { DEFAULT_VAULT_CONFIG, AES_GCM_IV_LENGTH, AES_GCM_TAG_LENGTH, DecryptionError, } from './types.js';
const AES_ALGORITHM = 'aes-256-gcm';
export async function deriveKey(password, salt, config = DEFAULT_VAULT_CONFIG) {
...
export function generateSalt(length = DEFAULT_VAULT_CONFIG.saltLength) {
    return randomBytes(length);
}
export function generateIV(length = AES_GCM_IV_LENGTH) {
    return randomBytes(length);
}
...
export function deserializeEncryptedData(data) {
    return {
