...
### Build Targets
- `make build` - Build all components (host, runtime, ui, edge)
...
- `make format-ui` - Format React/TypeScript code (prettier)
- `make format-edge` - Format Cloudflare Workers code (prettier)
...
- `make install-tools` - Install development tools (pre-commit, golangci-lint, Tauri CLI, Wrangler)
