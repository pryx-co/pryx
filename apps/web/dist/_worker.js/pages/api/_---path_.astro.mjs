...
const ALLOWED_TELEMETRY_FIELDS = /* @__PURE__ */ new Set([
  "correlation_id",
  "timestamp",
  "level",
  "category",
...
app.get("/update/manifest", async (c) => {
  c.req.query("platform") || "darwin-aarch64";
  c.req.query("arch") || "aarch64";
  const manifest = {
    version: "0.1.1",
